...
const Navbar = () => {
  const [homeDirectory, setHomeDirectory] = useState("unselected");
  const [discoverDirectory, setDiscoverDirectory] = useState("unselected");
  const [libraryDirectory, setLibraryDirectory] = useState("unselected");
  const [reportDirectory, setReportDirectory] = useState("unselected");
  const [groupsDirectory, setGroupsDirectory] = useState("unselected");
  const [marketDirectory, setMarketDirectory] = useState("unselected");

  const location = useLocation();

  if (location.pathname === "/home" && homeDirectory === "unselected") {
    setDiscoverDirectory("unselected");
    setHomeDirectory("selected");
    setLibraryDirectory("unselected");
    setReportDirectory("unselected");
    setGroupsDirectory("unselected");
    setMarketDirectory("unselected");
  } else if (
    location.pathname === "/discover" &&
    discoverDirectory === "unselected"
  ) {
    setDiscoverDirectory("selected");
    setHomeDirectory("unselected");
    setLibraryDirectory("unselected");
    setReportDirectory("unselected");
    setGroupsDirectory("unselected");
    setMarketDirectory("unselected");
    ...
    reportDirectory === "unselected"
  ) {
    setDiscoverDirectory("unselected");
    setHomeDirectory("unselected");
    setLibraryDirectory("unselected");
    setReportDirectory("selected");
    setGroupsDirectory("unselected");
    setMarketDirectory("unselected");
  } else if (
    location.pathname === "/reports" &&
    ...
    groupsDirectory === "unselected"
  ) {
    setDiscoverDirectory("unselected");
    setHomeDirectory("unselected");
    setLibraryDirectory("unselected");
    setReportDirectory("unselected");
    setGroupsDirectory("selected");
    setMarketDirectory("unselected");
  } else if (
    location.pathname === "/marketplace" &&
    marketDirectory === "unselected"
  ) {
    setDiscoverDirectory("unselected");
    setHomeDirectory("unselected");
    setLibraryDirectory("unselected");
  ...
  return (
    <nav className="navLoggedIn">
      ...
      <div className={"nav-offcanvas " + canvasMenu}>
      ...
      <ul className="nav-main-items">
        ...
        <li className={"nav-main-item home " + homeDirectory}>
          <span
            data-functional-selector="icon"
            style={{
              display: "inline-block",
