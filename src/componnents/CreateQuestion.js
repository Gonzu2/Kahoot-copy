  ...
  return (
        <div className="middle-main">
          <div className="question-title">
            <input type="text" placeholder="Start typing your question" maxLength={MAX_TITLE} onChange={updateTitle}/>
          ...
          <div className="answer-btns-container">
              <div className={answerValue.red.value !== '' ? "answer-btn red" : "answer-btn" } id="red">
                ...
                <div className="text-input-box">
                  ...
                  <span data-text="true" contenteditable="true"  onPaste={handlePaste} onInput={handleChange} onKeyDown={handleKeyDown} data-placeholder="Add answer 1" data-name="red"></span>
                  <span className="charsLeft">{remainingChars.red}</span>
                </div> 
                <div className="radio-btn">
                  <div className="check-box-outer" onClick={toogleCheckBox} data-name="red">
                  <div  className={answerValue.red.correctAnswer === true ? "check-box-inner check-box-checked" : "check-box-inner"} style={{ pointerEvents: "none" }}></div>   
                  </div>
                </div>
              </div>
              <div className={answerValue.blue.value !== "" ? "answer-btn blue" : "answer-btn" } id="blue">
              <div className="shape-container">
                  <div className="shape">
                ...
                <div className="text-input-box">
                <span data-text="true" contenteditable="true"  onPaste={handlePaste} onInput={handleChange} onKeyDown={handleKeyDown} data-placeholder="Add answer 2" data-name="blue"></span>
                  <span className="charsLeft">{remainingChars.blue}</span>
                </div>
                <div className="radio-btn">
                <div className="check-box-outer" onClick={toogleCheckBox} data-name="blue">
                  <div  className={answerValue.blue.correctAnswer === true ? "check-box-inner check-box-checked" : "check-box-inner"} style={{ pointerEvents: "none" }}></div>   
                  </div>
                </div>
              </div>
              <div className={answerValue.yellow.value !== "" ? "answer-btn yellow" : "answer-btn" } id="yellow">
              <div className="shape-container">
                  <div className="shape">
                ...
                <div className="text-input-box">
                <span data-text="true" contenteditable="true"  onPaste={handlePaste} onInput={handleChange} onKeyDown={handleKeyDown} data-placeholder="Add answer 3 (optional)" data-name="yellow"></span>
                  <span className="charsLeft">{remainingChars.yellow}</span>
                </div>
                <div className="radio-btn">
                <div className="check-box-outer" onClick={toogleCheckBox} data-name="yellow">
                  <div  className={answerValue.yellow.correctAnswer === true ? "check-box-inner check-box-checked" : "check-box-inner"} style={{ pointerEvents: "none" }}></div>   
                  </div>
                </div>
              </div>
              <div className={answerValue.green.value !== "" ? "answer-btn green" : "answer-btn" } id="green">
              <div className="shape-container">
                  <div className="shape">
                ...
                <div className="text-input-box">
                <span data-text="true" contenteditable="true"  onPaste={handlePaste} onInput={handleChange} onKeyDown={handleKeyDown} data-placeholder="Add answer 4 (optional)" data-name="green"></span>
                  <span className="charsLeft">{remainingChars.green}</span>
                </div>
                <div className="radio-btn">
                <div className="check-box-outer" onClick={toogleCheckBox} data-name="green">
                  <div  className={answerValue.green.correctAnswer === true ? "check-box-inner check-box-checked" : "check-box-inner"} style={{ pointerEvents: "none" }}></div>   
                  </div>
                </div>
              </div>
            </div>
