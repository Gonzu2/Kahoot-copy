...
function CreateQuiz() {
  ...
  const saveAnswers = (title,answers) => {
    const newQuiz = {
      title,
      answers
    } 
  ...
  const handleOnSave = () => {
    if(quiz.title !== "" || quiz.answers.red.value !== "" || quiz.answers.blue.value !== "" || quiz.answers !== null){
      if(quiz.answers.red.correctAnswer !== false || quiz.answers.blue.correctAnswer !== false || quiz.answers.green.correctAnswer !== false || quiz.answers.yellow.correctAnswer !== false){
        console.log(quiz)
      } else { console.log("please choose a atleast one correct answer")}
    } else { console.log("please fill your tiitle and ananswers 2 minimum")}
  }
  return (
    <div id="create-main">
      ...
      <div className="create-main-container">
        ...
        <Question className="middle-main"  onAnswerChange={saveAnswers}/>
