      ...
      <div className="create-main-container">
        ...
        <div className="middle-main">
          ...
          <div className="answer-btns-container">
            <div
              className={
                answerValue.red !== "" ? "answer-btn red" : "answer-btn"
              }
              id="red">
            ...
            <div
              className={
                answerValue.blue !== "" ? "answer-btn blue" : "answer-btn"
              }
              id="blue">
              <div className="shape-container">
                <div className="shape">
            ...
            <div
              className={
                answerValue.yellow !== "" ? "answer-btn yellow" : "answer-btn"
              }
              id="yellow">
              <div className="shape-container">
                <div className="shape">
            ...
            <div
              className={
                answerValue.green !== "" ? "answer-btn green" : "answer-btn"
              }
              id="green">
              <div className="shape-container">
                <div className="shape">
